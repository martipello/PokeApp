...
data class Type(
    ...
    companion object {
        ...
        fun getTypesInOrder(types: List<com.sealstudios.pokemonApp.database.`object`.Type>): List<com.sealstudios.pokemonApp.database.`object`.Type> {
            return types.sortedBy { it.name }
        }

        fun mapDbPokemonTypesFromPokemonResponse(apiPokemon: ApiPokemon): List<com.sealstudios.pokemonApp.database.`object`.Type> {
            return apiPokemon.types.map { apiType ->
                mapDbPokemonTypeFromPokemonResponse(apiType)
            }
        }

        fun mapDbPokemonTypeFromPokemonResponse(apiPokemonType: ApiPokemonType): com.sealstudios.pokemonApp.database.`object`.Type {
            return Type(
        ...
        fun mapDbPokemonTypeFromTypeResponse(type: Type): com.sealstudios.pokemonApp.database.`object`.Type {
            return Type(
                    id = type.id,
                    name = type.name ?: "",
