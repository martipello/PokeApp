...
import com.sealstudios.pokemonApp.database.`object`.AbilityMetaData.Companion.ABILITY_META_DATA_ID
import org.jetbrains.annotations.NotNull

@Entity(primaryKeys = [POKEMON_ID, ABILITY_META_DATA_ID])
class AbilityMetaDataJoin(
        @NotNull
    ...
    companion object {
        ...
        fun createPokemonAbilityMetaDataJoin(remotePokemonId: Int, pokemonAbilityId: Int): AbilityMetaDataJoin {
            return AbilityMetaDataJoin(
                    remotePokemonId,
