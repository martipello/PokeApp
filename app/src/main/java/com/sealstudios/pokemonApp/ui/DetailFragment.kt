...
import com.sealstudios.pokemonApp.databinding.DetailFragmentBinding
import com.sealstudios.pokemonApp.ui.adapter.DetailViewPagerAdapter
...
import com.sealstudios.pokemonApp.ui.insets.DetailFragmentInsets
...
@AndroidEntryPoint
class DetailFragment : DetailAnimationManager() {
    ...
    private lateinit var viewPagerAdapterAdapter: DetailViewPagerAdapter
    ...
    private fun setUpViewPagerAdapter() {
        viewPagerAdapterAdapter = DetailViewPagerAdapter(this)
    }
    ...
    private fun DetailFragmentBinding.setNotEmpty() {
        mainProgress.root.visibility = View.GONE
        errorLayout.root.visibility = View.GONE
        content.visibility = View.VISIBLE
    }

    private fun DetailFragmentBinding.setLoading() {
    ...
    private fun DetailFragmentBinding.setSpeciesEmpty() {
        subtitle.visibility = View.GONE
        genTextView.visibility = View.GONE
        genTextLabel.visibility = View.GONE
    }

    private fun DetailFragmentBinding.setSpeciesNotEmpty() {
