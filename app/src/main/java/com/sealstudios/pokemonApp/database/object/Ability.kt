...
@Entity
data class Ability @JvmOverloads constructor(
    ...
    companion object {
        fun mapRemotePokemonAbilityToDatabasePokemonAbility(ability: Ability): com.sealstudios.pokemonApp.database.`object`.Ability {
            return Ability(
                    id = ability.id,
                    name = ability.name ?: "",
