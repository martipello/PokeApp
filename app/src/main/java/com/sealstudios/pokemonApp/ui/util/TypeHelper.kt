...
import com.sealstudios.pokemonApp.database.`object`.Type as pokemonType

enum class PokemonType(val color: Int, val icon: Int, val id: Int) {
...
//    UNKNOWN(color = R.color.white, icon = R.drawable.ic_pokeball);
    ...
    NORMAL(color = R.color.normal, icon = R.drawable.normal_type_icon, id = 1),
    FIGHTING(color = R.color.fighting, icon = R.drawable.fighting_type_icon, id = 2),
    FLYING(color = R.color.flying, icon = R.drawable.flying_type_icon, id = 3),
    POISON(color = R.color.poison, icon = R.drawable.poison_type_icon, id = 4),
    GROUND(color = R.color.ground, icon = R.drawable.ground_type_icon, id = 5),
    ROCK(color = R.color.rock, icon = R.drawable.rock_type_icon, id = 6),
    BUG(color = R.color.bug, icon = R.drawable.bug_type_icon, id = 7),
    GHOST(color = R.color.ghost, icon = R.drawable.ghost_type_icon, id = 8),
    STEEL(color = R.color.steel, icon = R.drawable.steel_type_icon, id = 9),
    FIRE(color = R.color.fire, icon = R.drawable.fire_type_icon, id = 10),
    WATER(color = R.color.water, icon = R.drawable.water_type_icon, id = 11),
    GRASS(color = R.color.grass, icon = R.drawable.grass_type_icon, id = 12),
    ELECTRIC(color = R.color.electric, icon = R.drawable.lightning_type_icon, id = 13),
    PSYCHIC(color = R.color.psychic, icon = R.drawable.psychic_type_icon, id = 14),
    ICE(color = R.color.ice, icon = R.drawable.ice_type_icon, id = 15),
    DRAGON(color = R.color.dragon, icon = R.drawable.dragon_type_icon, id = 16),
    DARK(color = R.color.dark, icon = R.drawable.dark_type_icon, id = 17),
    FAIRY(color = R.color.fairy, icon = R.drawable.fairy_type_icon, id = 18),
    SHADOW(color = R.color.white, icon = R.drawable.ic_pokeball, id = 10002),
    UNKNOWN(color = R.color.white, icon = R.drawable.ic_pokeball, id = 10001);
    ...
    companion object {
        ...
        fun getAllPokemonTypeIds(): List<Int> {
            return enumValues<PokemonType>().asList().map { it.id }
        }
